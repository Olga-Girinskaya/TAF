...
public class TestDouble extends BaseTest {
    ...
    public void testDivDouble1() {
        Assert.assertEquals(calculator.divDouble(4.5, 3), 1.5, "Неверный ответ....");
    }

    @Test(testName = "Деление на '0' double числа", dependsOnMethods = "testDivDouble3")
    public void testDivDouble2() {
        Assert.assertEquals(Double.POSITIVE_INFINITY, 12d/0);
    }
    ...
    public void testEnabled() {
        Assert.assertEquals(calculator.divDouble(4.5, 3), 1.5, "Неверная сумма...");
    }
    ...
    public void testDataProvider(double a, double b, double expectedResult) {
        Assert.assertEquals(calculator.divDouble(a, b), expectedResult, "Неверная сумма...");
    }
}