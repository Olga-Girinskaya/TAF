...
public class TestInt extends BaseTest {
    ...
    public void testDivInt1() {
        Assert.assertEquals(calculator.div(6, 2), 3, "Неверный ответ....");
    }
    ...
    public void testDivInt2() {
        Assert.assertEquals(calculator.div(6, 0), 0, "Неверный ответ....");
    }
    ...
    public void invocationCountTest2() throws InterruptedException {
        Thread.sleep(500);
        Assert.assertEquals(calculator.div(6, 2), 3, "Неверная сумма...");
    }
